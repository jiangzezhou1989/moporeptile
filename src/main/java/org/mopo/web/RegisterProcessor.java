...
import org.mopo.repository.UserRepository;
...
public final class RegisterProcessor {
	...
	private static final Logger LOGGER = Logger
			.getLogger(RegisterProcessor.class.getName());
	/**
	 * User repository.
	 */
	...
	private void saveUser(final String name) {
		...
		try {
			...
			LOGGER.log(Level.INFO, "Register a user successfully[userId={0}]",
					userId);
